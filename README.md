# cmu-18744-av-viplanner-project
...
The README should answer these immediately:

What is this project?
Was it a CMU class project?
What original open-source repo was used?
What did your team add or modify?
What did you personally contribute?Early WSL+Ubuntu setup, high-speed computing hardware purveyor, Isaac-Sim Limo diff-drive exploration, Carla-map exploration, simulation vehicle testing, and ViPlanner demo testing and benchmarking.Contributed to simulation setup and testing for a CMU 18-744 autonomous navigation project using ViPlanner, Isaac Sim, and a Limo mobile robot platform.
